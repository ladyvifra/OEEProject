...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="../orders/viewOrder.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../apture/selectCapture.php">
    ...
    ?>
                <div class="row-2">
                  <div class="row header">
                        <h1 class="companyName"> Registrar nuevo usuario  &nbsp;</h1>
                        <h3>Estimado usuario, por favor registre la siguiente información del nuevo usuario:</h3>
                    </div>
                    <div class="row p-0">
                    <form class="col-12 p-0" role="form" name="formUser" method="post" action = "validateUserForm.php">
                    <div class="row p-0">
                            <div class="col-md-12">
                                <div class="card m-2">
                                    <div class="card-body">
                                            ...
                                            <div class="col-6">
                                                <label for="role">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input value= 2 class="form-check-input" type="radio" name="role" id="role" style="margin-left:-56px;">
                                                    ...
                                                    <div class="form-check">
                                                        <input value= 1 class="form-check-input" type="radio" name="role" id="role" checked style="margin-left:-56px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row m-2">
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    <div class="row m-2">
                                                    <input class="btn btn-submit" type="button" value="Cancelar" onClick="window.location='../mainMenu.php'">
