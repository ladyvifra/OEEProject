...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item ">
                <a class="nav-link" href="registerOrder.php" >
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a href="../login/viewUsers.php.php" class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
    ...
    ?>
                <div class="container">
                    ...
                    <div class="row header">
                        <h1>Registrar orden de producción  &nbsp;</h1>
                        <h3>Estimado usuario, por favor registre la orden de producción:</h3>
                    </div>
                    <div class="row body">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="col-12">
                                    <p align="left"> Si la orden está asociada a una sucursal, por favor seleccionela
