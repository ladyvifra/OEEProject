...
<head>
    ...
    <title>Register Stop production</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseStops" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="viewProducts.php">Ver paradas</a>
                        <a class="collapse-item" href="registerStopProduction.php">Registrar parada</a>
                    </div>
                </div>
            </li>
    ...
    ?>
               <div class="container">
                    ...
                    <div class="row header">
                        ...
                        <h3>Estimado usuario, por favor registre la siguiente información del tipo de parada:</h3>
                    </div>
                    <div class="row body">
                        <form role="form" name="formStop" method="post" action = "validateStopForm.php">
                        <ul>
                            
                            <li>
                            <p class="left">
                                <label for="first_name">Nombre de la parada</label>
